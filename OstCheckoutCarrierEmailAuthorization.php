...
namespace OstCheckoutCarrierEmailAuthorization;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstCheckoutCarrierEmailAuthorization extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_checkout_carrier_email_authorization.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_checkout_carrier_email_authorization.view_dir', $this->getPath() . '/Resources/views/');
